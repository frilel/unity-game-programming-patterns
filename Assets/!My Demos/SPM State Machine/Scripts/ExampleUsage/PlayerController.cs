...
namespace DesignPatterns.SPMState
{
    ...
    {
        [SerializeField] string stateFilepath = "SPM StateMachine States/";
        ...
        private void Start()
        {
            // initialize state machine with all the states we have created
            InitializeStateMachine(Resources.LoadAll<State>(stateFilepath));

        }
        void InitializeStateMachine(State[] states)
        {
